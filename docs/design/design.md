# Lumen Design System (Target Path)
...
> Follow-up: migrate the full design content from `attached_assets/design_1774337956218.md` into this file in a dedicated docs cleanup PR. Until then, treat this file as a pointer, not the authoritative design spec.
