...
| [0002](0002-on-device-first-ai-with-apple-foundation-models.md) | On-device-first AI with Apple FoundationModels | Accepted 2025-10-01 |
| [0003](0003-swiftdata-over-core-data.md) | SwiftData over Core Data | Accepted 2025-10-01 |
| [0004](0004-no-backend-serverless-architecture.md) | No backend / serverless architecture | Accepted 2025-10-01 |
| [0005](0005-keychain-for-credential-storage.md) | Keychain for credential storage | Accepted 2025-10-01 |
