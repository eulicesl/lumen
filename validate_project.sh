...
check_file "$LUMEN/Views/Shared/Chat/MessageContentView.swift"
check_file "$LUMEN/Views/Shared/Chat/CodeBlockView.swift"
...
check_file "$LUMEN/Extensions/SyntaxHighlighter.swift"
echo ""
